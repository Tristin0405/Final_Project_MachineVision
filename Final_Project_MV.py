#Đỗ Trần Quang Hà - 23146010
#Thượng Trí Tín - 23146038
import cv2 as cv
import numpy as np

# PHẦN 1: TỰ ĐỘNG TÌM VẠCH SÂN VÀ TÍNH MA TRẬN M 
cap = cv.VideoCapture(r"D:\MonHoc\MachineVision\Final\Badminton.mp4")
...
# PHẦN 3: VÒNG LẶP CHÍNH (TRACKING và VẼ HEATMAP)
while cap.isOpened(): 
    ret, frame = cap.read()
    if not ret: break
